...
describe("Market Link Generators", () => {
  ...
  it("handleLisSkinsReferenceLink creates clean item slug links on lis-skins.com", () => {
    expect(
      handleLisSkinsReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe("https://lis-skins.com/market/csgo/glock-18-shinobu-factory-new/");
    expect(
      handleLisSkinsReferenceLink("StatTrak™ Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleSkinflowReferenceLink formats Skinflow search query with stattrak/souvenir flags", () => {
    ...
    expect(
      handleSkinflowReferenceLink("StatTrak™ Glock-18 | Shinobu (Factory New)"),
    ).toBe(
    ...
    expect(
      handleSkinflowReferenceLink("Souvenir Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleWhiteMarketReferenceLink formats item link with appId and nameHash", () => {
    expect(
      handleWhiteMarketReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleCsgoMarketReferenceLink formats Market.CSGO search query with categories filter", () => {
    expect(
      handleCsgoMarketReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleShadowPayReferenceLink formats exteriors, is_stattrak, and is_souvenir params correctly", () => {
    expect(
      handleShadowPayReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe(
    ...
    expect(
      handleShadowPayReferenceLink("Souvenir Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleTradeitReferenceLink handles StatTrak and Souvenir params correctly", () => {
    ...
    expect(
      handleTradeitReferenceLink("StatTrak™ Glock-18 | Shinobu (Factory New)"),
    ).toBe(
    ...
    expect(
      handleTradeitReferenceLink("Souvenir Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleSkinlandReferenceLink formats skin.land cs2 market slug links", () => {
    expect(
      handleSkinlandReferenceLink("★ Driver Gloves | Black Tie (Factory New)"),
    ).toBe(
      "https://skin.land/market/cs2/%E2%98%85-driver-gloves-black-tie-factory-new",
    );
    expect(
      handleSkinlandReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe("https://skin.land/market/cs2/glock-18-shinobu-factory-new");
  });
  ...
  it("handleBuffMarketReferenceLink formats goods/cs2 direct item links", () => {
    ...
    expect(
      handleBuffMarketReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe(
  ...
  it("handleSkinsComReferenceLink formats skins.com item URLs with exterior and st query params", () => {
    expect(
      handleSkinsComReferenceLink("StatTrak™ Glock-18 | Shinobu (Factory New)"),
    ).toBe("https://skins.com/item/glock-18-shinobu?exterior=fn&st=true");
    expect(
      handleSkinsComReferenceLink(
        "StatTrak™ Bowie Knife | Autotronic (Factory New)",
      ),
    ).toBe("https://skins.com/item/bowie-knife-autotronic?exterior=fn&st=true");
    expect(
      handleSkinsComReferenceLink("Bowie Knife | Autotronic (Factory New)"),
    ).toBe("https://skins.com/item/bowie-knife-autotronic?exterior=fn");
    expect(
      handleSkinsComReferenceLink("★ Driver Gloves | Black Tie (Factory New)"),
    ).toBe("https://skins.com/item/driver-gloves-black-tie?exterior=fn");
  });

  it("handleSkinBaronReferenceLink formats SkinBaron category/weapon/skin/exterior URLs", () => {
    expect(
      handleSkinBaronReferenceLink("Glock-18 | Shinobu (Factory New)"),
    ).toBe(
    ...
    expect(
      handleSkinBaronReferenceLink("★ Driver Gloves | Black Tie (Factory New)"),
    ).toBe(
  ...
  it("getMarketItemUrl dispatches properly and resolves all supported platform aliases", () => {
    ...
    expect(getMarketItemUrl("dmarket_target", "AK-47 | Redline")).toContain(
      "dmarket.com",
    );
    expect(getMarketItemUrl("dmarket_f", "AK-47 | Redline")).toContain(
      "dmarket.com",
    );
    expect(
      getMarketItemUrl("skinscom", "Glock-18 | Shinobu (Factory New)"),
    ).toContain("skins.com");
    expect(
      getMarketItemUrl("skinbaron", "Glock-18 | Shinobu (Factory New)"),
    ).toContain("skinbaron.de");
    expect(getMarketItemUrl("skinswap", "AK-47 | Redline")).toContain(
      "skinswap.com",
    );
    expect(getMarketItemUrl("skinswap_market", "AK-47 | Redline")).toContain(
      "skinswap.com",
    );
    expect(getMarketItemUrl("skinswap_trade", "AK-47 | Redline")).toContain(
      "skinswap.com",
    );
    expect(getMarketItemUrl("whitemarket", "AK-47 | Redline")).toContain(
      "white.market",
    );
    expect(getMarketItemUrl("skinflow", "AK-47 | Redline")).toContain(
      "skinflow.gg",
    );
    expect(
      getMarketItemUrl("mannco", "Glock-18 | Shinobu (Factory New)"),
    ).toContain("mannco.store");
    expect(
      getMarketItemUrl("skinland", "Glock-18 | Shinobu (Factory New)"),
    ).toContain("skin.land");
    expect(
      getMarketItemUrl("buffmarket", "Glock-18 | Shinobu (Factory New)"),
    ).toContain("buff.market");
