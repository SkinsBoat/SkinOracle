...
export default function UpdateNotification({
  ...
  if (
    ...
    dismissedVersion === updateState.info.version
  ) {
    return null;
  }
    ...
    <div
      style={{
        ...
        border: isMandatory
          ...
          : "1px solid var(--so-border-strong)",
        borderRadius: "12px",
        padding: "16px 20px",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                ...
                >
                  {isMandatory
                    ? `Mandatory Update (v${updateState.info?.version})`
            ...
            {!isMandatory && (
              <button
                onClick={() =>
                  setDismissedVersion(updateState.info?.version || "1.0")
                }
                style={{
                  background: "none",
                  border: "none",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          >
            ...
            <span>
              ...
              MB /{" "}
              {((updateState.progress?.total || 0) / (1024 * 1024)).toFixed(1)}{" "}
              MB
            </span>
          </div>
        </div>
