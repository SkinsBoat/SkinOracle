        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          {totalCacheCount > 0 && (
            <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--so-cyan-text)' }}>
              Passing Filters: {passingFilterCount.toLocaleString()} / {totalCacheCount.toLocaleString()} items
            </div>
          )}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '10px', marginBottom: '16px' }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: 'var(--so-text-muted)' }}>Removes Souvenir package drops</div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: 'var(--so-text-muted)' }}>Removes kill-tracker weapons</div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: 'var(--so-text-muted)' }}>Removes standalone stickers & patches</div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: 'var(--so-text-muted)', opacity: 0.8 }}>Forced Filtered Out (Locked)</div>
          </div>
        </div>
      </div>
