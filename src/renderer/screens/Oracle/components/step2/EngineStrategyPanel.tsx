    ...
    <>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              border:
                selectedEngine === "standard"
                  ? "2px solid var(--so-cyan-text, #0ea5e9)"
          ...
          >
            ...
            {selectedEngine === "standard" && (
              <Check size={18} style={{ color: "var(--so-cyan-text)" }} />
            )}
          </div>
          ...
          <div
            ...
            style={{
              ...
              border:
                selectedEngine === "nexus"
                  ? "2px solid var(--so-primary, #6366f1)"
                  : "1px solid var(--so-border-medium)",
              boxShadow:
                selectedEngine === "nexus"
                  ? "0 0 16px rgba(99, 102, 241, 0.22)"
                  : "none",
              cursor: "pointer",
              transition: "all 0.18s ease",
              userSelect: "none",
          ...
          >
            ...
            {selectedEngine === "nexus" && (
              <Check size={18} style={{ color: "var(--so-primary)" }} />
            )}
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            <Compass size={16} style={{ color: "var(--so-cyan-text)" }} />{" "}
        ...
        >
          ...
          >
            ...
            >
              <Activity size={14} style={{ color: "var(--so-cyan-text)" }} />{" "}
          ...
          >
            ...
            >
              <Cpu size={14} style={{ color: "var(--so-primary)" }} /> Pricing
              Target Profile
            </div>
            <div
              style={{
