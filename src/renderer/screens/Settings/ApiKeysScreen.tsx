...
export default function ApiKeysScreen() {
  ...
  const revokeKey = async (
    ...
    if (!confirm(`Are you sure you want to revoke and remove your ${label}?`))
      return;
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <div>
        ...
        >
          <Settings size={24} style={{ color: "var(--so-primary)" }} /> API Keys
          & Security Settings
        </h1>
        <p
          style={{
        ...
        >
          Manage local API keys and exchange tokens. All secrets are stored
          exclusively in your local device keychain.
        </p>
      </div>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div>
            ...
            >
              Your API keys and session tokens are stored exclusively on your
              device using native OS cryptographic storage (
              <strong>macOS Keychain</strong>, <strong>Windows DPAPI</strong>,
              or <strong>Linux Secret Service</strong>).
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <span>
              <strong>Zero Cloud Storage:</strong> Keys are never uploaded to
              our servers.
            </span>
          </div>
          <div
          ...
          >
            ...
            <span>
              <strong>Direct Calls:</strong> Requests go straight from your
              desktop to CSFloat & Skinsnipe.
            </span>
          </div>
          <div
            style={{
          ...
          >
            ...
            <span>
              <strong>Protected Binary:</strong> Production app code is
              obfuscated to prevent extraction.
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <p className="card-desc">
          Used to query market pricing databases and cache live skin listings
      ...
      <div className="card">
        ...
        <p className="card-desc">
          Enables high-speed live NDJSON streaming of full CS2 market catalogs
          across 40+ providers (Buff163, C5, CSFloat, AvanMarket, etc.).
        </p>
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          <input
            type="password"
      ...
      <div className="card">
        ...
        <p className="card-desc">
          Allows the CSFloat Workstation to fetch buy orders, execute single
          order updates, and run automated batch price adjustments.
        </p>
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          <input
            type="password"
      ...
      <div className="card">
        ...
        <p className="card-desc">
          Enables the DMarket Workstation to query targets, monitor live USD
          balance, and execute automated target adjustments directly from your
          device with Ed25519 request signing.
        </p>
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          >
            ...
            >
              <Save size={14} />{" "}
              {saving === "dmarket" ? "Saving..." : "Save DMarket Keys"}
            </button>
            {keysStatus.hasDmarketKeys && (
              <button
                className="btn"
              ...
              >
                <Trash2 size={14} />{" "}
                {saving === "revoke_dmarket" ? "Revoking..." : "Revoke"}
              </button>
            )}
          </div>
        </div>
