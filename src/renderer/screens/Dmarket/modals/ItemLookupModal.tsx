...
export const ItemLookupModal: React.FC<ItemLookupModalProps> = ({ item, onClose, onOpenMarket }) => {
  if (!item) return null;
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '10px' }}>
          ...
          >
            <div style={{ fontSize: '10.5px', color: 'var(--so-text-muted)', fontWeight: 600 }}>
              Target Buy Ceiling
            </div>
            <div
              className="tabular-nums"
              style={{ fontSize: '16px', fontWeight: 900, color: 'var(--so-accent-cyan)', marginTop: '2px' }}
            >
          ...
          >
            ...
            <div
              className="tabular-nums"
              style={{ fontSize: '16px', fontWeight: 900, color: '#f59e0b', marginTop: '2px' }}
            >
          ...
          >
            <div style={{ fontSize: '10.5px', color: 'var(--so-text-muted)', fontWeight: 600 }}>
              Lowest Global Listing
            </div>
            <div
              className="tabular-nums"
              style={{ fontSize: '16px', fontWeight: 900, color: '#ffffff', marginTop: '2px' }}
            >
          ...
          >
            ...
            <div
              className="tabular-nums"
              style={{ fontSize: '16px', fontWeight: 900, color: 'var(--so-primary)', marginTop: '2px' }}
            >
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
                <thead>
                  ...
                  >
                    ...
                    <th style={{ padding: '6px 10px', fontWeight: 700, textAlign: 'right' }}>
                      Lowest Active Price
                    </th>
                  </tr>
                </thead>
