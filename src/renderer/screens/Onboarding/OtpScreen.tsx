    ...
    <div className="auth-screen">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">
          Enter 6-digit verification code sent to <strong style={{ color: 'var(--so-text-primary)' }}>{email}</strong>
        </p>
        <p style={{ color: 'var(--so-text-tertiary, #a0a0a0)', fontSize: '12px', marginTop: '-12px', marginBottom: '16px' }}>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div>
            ...
            <input
              ...
              style={{ fontSize: '20px', letterSpacing: '4px', textAlign: 'center', fontWeight: 800 }}
              required
            />
          </div>
