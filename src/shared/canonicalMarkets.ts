...
export const CANONICAL_MARKETS: CanonicalMarketInfo[] = [
  { id: 'csfloat', name: 'CSFloat', aliases: ['csgofloat', 'csfloat', 'cs_float'] },
  { id: 'buff163', name: 'BUFF163', aliases: ['buff163', 'buff_163', 'buff'] },
  { id: 'buffmarket', name: 'BUFF.Market', aliases: ['buffmarket', 'buff_market'] },
  { id: 'dmarket', name: 'DMarket', aliases: ['dmarket', 'd_market'] },
  { id: 'steam', name: 'Steam Community Market', aliases: ['steam', 'steam_market', 'scm'] },
  { id: 'csmoney_market', name: 'CS.MONEY (Market)', aliases: ['csmoney_m', 'csmoney_p2p', 'csmoney_market'] },
  { id: 'csmoney_trade', name: 'CS.MONEY (Trade)', aliases: ['csmoney_t', 'csmoney_trade'] },
  { id: 'tradeit', name: 'Tradeit.gg', aliases: ['tradeit', 'tradeitgg', 'tradeitgg_store'] },
  { id: 'market_csgo', name: 'Market.CSGO', aliases: ['marketcsgo', 'market_csgo', 'market-csgo'] },
  { id: 'skinport', name: 'Skinport', aliases: ['skinport', 'skin_port'] },
  { id: 'skinscom', name: 'Skins.com', aliases: ['skinscom', 'skins_com'] },
  { id: 'lisskins', name: 'LIS-SKINS', aliases: ['lisskins', 'lis_skins', 'lis-skins'] },
  { id: 'skinland', name: 'Skin.Land', aliases: ['skinland', 'skin_land', 'skin-land'] },
  { id: 'skinflow', name: 'Skinflow', aliases: ['skinflow', 'skin_flow'] },
  { id: 'shadowpay', name: 'ShadowPay', aliases: ['shadowpay', 'shadow_pay'] },
  { id: 'skinswap_market', name: 'SkinSwap (Market)', aliases: ['skinswap', 'skinswap_market', 'skinswap_m'] },
  { id: 'skinswap_trade', name: 'SkinSwap (Trade)', aliases: ['skinswap_t', 'skinswap_trade'] },
  { id: 'avanmarket', name: 'Avan.Market', aliases: ['avanmarket', 'avan_market', 'avan'] },
  ...
  { id: 'whitemarket', name: 'white.market', aliases: ['whitemarket', 'white_market', 'white.market'] },
  { id: 'waxpeer', name: 'WAXPEER', aliases: ['waxpeer', 'wax_peer'] },
  { id: 'mannco', name: 'Mannco.store', aliases: ['mannco', 'manncostore', 'mannco_store'] },
  { id: 'exeskins', name: 'ExeSkins', aliases: ['exeskins', 'exe_skins'] },
  { id: 'itradegg', name: 'iTrade.gg', aliases: ['itradegg', 'itrade'] },
  { id: 'pirateswap', name: 'PirateSwap', aliases: ['pirateswap', 'pirate_swap'] },
  { id: 'rapidskins', name: 'RapidSkins', aliases: ['rapidskins', 'rapid_skins'] },
  ...
  { id: 'skinsmonkey', name: 'SkinsMonkey', aliases: ['skinsmonkey', 'skins_monkey'] },
  ...
  { id: 'lootfarm', name: 'LOOT.Farm', aliases: ['lootfarm', 'loot_farm', 'loot.farm'] },
  { id: 'merchanttf', name: 'Merchant TF', aliases: ['merchanttf', 'merchant_tf'] },
];
 ...
 */
export function toCanonicalMarketId(rawMarketId: string | null | undefined): string {
 ...
 */
export function getMarketDisplayName(marketId: string | null | undefined): string {
 ...
 */
export function isMarketMatch(rawIdA: string | null | undefined, rawIdB: string | null | undefined): boolean {
