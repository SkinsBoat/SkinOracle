...
describe("Version Gate & Auto-Updater Integration", () => {
  it("correctly structures VersionGateState for an outdated version", () => {
    const serverCheckResponse = {
      allowed: false,
      reason:
        "Version 0.1.4 is outdated or no longer supported. Please update to v0.1.5 or later.",
      minVersion: "0.1.5",
      latestVersion: "0.1.5",
    };
  ...
  it("intercepts HTTP 426 Upgrade Required and generates force-version-block event payload", () => {
    const mock426Response = {
      ...
      data: {
        ...
        error: {
          statusCode: 426,
          message:
            "Version 0.1.0 is outdated or no longer supported. Please update to v0.1.5 or later.",
          minVersion: "0.1.5",
        },
      },
    };
    ...
    const interceptor = (
      errResponse: typeof mock426Response,
      appVersion: string,
    ) => {
